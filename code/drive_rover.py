...
class RoverState():
    def __init__(self):
        ...
        self.rock_angels = None # Angles of rock terrain pixels
        self.rock_dists = None # Distances of nrock terrain pixels
        self.ground_truth = ground_truth_3d # Ground truth worldmap
        self.mode = 'forward' # Current mode (can be forward or stop or back)
        ...
        self.rock_stop = 2 # Threshold to initiate stopping if rock vector exists
        self.rock_go = 4 # Threshold to go forward when rock vector exists
        self.rock_exist = False
